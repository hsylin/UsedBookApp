...
public class signup extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (check_value(r, p, cp, fn, ln, dp, mob, ml) == 0) {
                    try {
                        ...
                        obj.put("mobile", mob);
                        obj.put("mail", ml);
                        String URL = "https://obscure-shelf-28256-aba2f7fd661a.herokuapp.com/signup";
    ...
    public int check_value(String roll, String pw, String cpw, String fname, String lname, String dept, String mob_no, String mail) {
        if (roll.length() != 9) {
            ...
            Toast.makeText(this, "Enter a valid Password with min 4 char", Toast.LENGTH_SHORT).show();
            return 1;
