...
public class nav_home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onResume() {
        ...
        if (global.post_q == 1) {
            ...
            String jsonStr = intent.getStringExtra("JSONObject");
    ...
    public void logout(){
        String URL = "https://obscure-shelf-28256-aba2f7fd661a.herokuapp.com/logout";
    ...
    public void getad() throws JSONException {
        ...
        String URL = "https://obscure-shelf-28256-aba2f7fd661a.herokuapp.com/getuserad";
    ...
    public void displaySelectedScreen1(final int itemid){
        p.setMessage("Loading...");
        p.show();
        String URL = "https://obscure-shelf-28256-aba2f7fd661a.herokuapp.com/getallad";
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
